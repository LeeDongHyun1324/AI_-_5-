...
본 서비스는 로그인 기능을 통해 작가와 독자의 역할을 구분합니다. 작가는 제목, 저자, 내용 정보를 입력하여 AI 표지를 생성하고 도서를 등록·수정·삭제할 수 있으며, 독자는 등록된 도서를 조회하고 좋아요와 댓글을 통해 의견을 남길 수 있습니다.

React와 SpringBoot를 사용해 개발되었으며, REST API를 통해 프론트엔드·백엔드 통신을 가능하게 하고, API를 연동하여 AI표지를 생성합니다. 또한 Postman을 활용한 API 테스트와 H2 Database를 활용한 데이터 검증 환경을 구축하여 개발 및 테스트를 진행하였습니다.
